...
HD_PWD='E:/My_Verilog/xadc_6/xadc_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xadc_top.tcl
