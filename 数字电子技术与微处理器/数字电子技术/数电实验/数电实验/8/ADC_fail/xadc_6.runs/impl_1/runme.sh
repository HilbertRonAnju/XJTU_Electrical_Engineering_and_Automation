...
HD_PWD='E:/My_Verilog/xadc_6/xadc_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xadc_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xadc_top.tcl -notrace
