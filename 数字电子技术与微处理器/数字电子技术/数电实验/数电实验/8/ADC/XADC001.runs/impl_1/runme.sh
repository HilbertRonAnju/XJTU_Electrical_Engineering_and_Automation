...
HD_PWD='D:/Users/whxxjj/Documents/Vivado/XADC001/XADC001.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wdnmd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wdnmd.tcl -notrace
