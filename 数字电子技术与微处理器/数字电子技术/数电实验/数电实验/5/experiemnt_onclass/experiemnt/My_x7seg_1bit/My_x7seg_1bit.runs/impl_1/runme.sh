...
HD_PWD='C:/Users/96547/Desktop/My_x7seg_1bit/My_x7seg_1bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log My_x7seg_1bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source My_x7seg_1bit.tcl -notrace
