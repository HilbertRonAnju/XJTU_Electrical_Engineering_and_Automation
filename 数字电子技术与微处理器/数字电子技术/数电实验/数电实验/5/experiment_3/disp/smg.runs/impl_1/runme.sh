...
HD_PWD='G:/vivado_project/day3/disp/smg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log smg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source smg.tcl -notrace
