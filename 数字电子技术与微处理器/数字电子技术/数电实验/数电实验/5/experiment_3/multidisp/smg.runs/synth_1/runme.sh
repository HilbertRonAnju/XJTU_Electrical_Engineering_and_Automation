...
HD_PWD='G:/vivado_project/day3/multidisp/smg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log muldisp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source muldisp.tcl
