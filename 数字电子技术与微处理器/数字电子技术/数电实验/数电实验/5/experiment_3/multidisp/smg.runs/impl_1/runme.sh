...
HD_PWD='G:/vivado_project/day3/multidisp/smg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log muldisp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source muldisp.tcl -notrace
