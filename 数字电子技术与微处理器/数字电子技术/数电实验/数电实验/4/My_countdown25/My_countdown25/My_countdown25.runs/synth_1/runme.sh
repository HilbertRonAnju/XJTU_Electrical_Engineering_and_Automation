...
HD_PWD='E:/My_Verilog/My_countdown25/My_countdown25.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log My_countdown25.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source My_countdown25.tcl
