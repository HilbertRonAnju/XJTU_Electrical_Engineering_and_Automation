...
HD_PWD='E:/My_Verilog/My_countdown25/My_countdown25.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log My_countdown25.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source My_countdown25.tcl -notrace
