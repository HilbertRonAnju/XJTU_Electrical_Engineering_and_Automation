...
HD_PWD='G:/vivado_project/secretgarden/chineseseries/fanqiezhong_30_involvestar/AD_DA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proclocktop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proclocktop.tcl
