...
HD_PWD='G:/vivado_project/secretgarden/chineseseries/fanqiezhong_30_involvestar/AD_DA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log proclocktop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source proclocktop.tcl -notrace
