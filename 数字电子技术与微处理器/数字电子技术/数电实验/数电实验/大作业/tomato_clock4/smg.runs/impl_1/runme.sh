...
HD_PWD='G:/vivado_project/day3/tomatoes/smg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tomatoclock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tomatoclock.tcl -notrace
