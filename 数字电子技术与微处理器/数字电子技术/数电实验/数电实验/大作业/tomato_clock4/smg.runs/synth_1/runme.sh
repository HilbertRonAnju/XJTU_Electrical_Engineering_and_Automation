...
HD_PWD='G:/vivado_project/day3/tomatoes/smg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tomatoclock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tomatoclock.tcl
