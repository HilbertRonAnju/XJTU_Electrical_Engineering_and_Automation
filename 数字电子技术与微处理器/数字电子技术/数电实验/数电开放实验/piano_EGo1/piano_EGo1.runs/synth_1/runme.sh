...
HD_PWD='D:/List_Vivado/2017_4/piano_EGo1/piano_EGo1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_piano.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_piano.tcl
