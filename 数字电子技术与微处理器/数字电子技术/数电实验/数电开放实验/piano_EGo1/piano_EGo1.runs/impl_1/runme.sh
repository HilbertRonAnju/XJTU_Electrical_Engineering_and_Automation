...
HD_PWD='D:/List_Vivado/2017_4/piano_EGo1/piano_EGo1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_piano.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_piano.tcl -notrace
